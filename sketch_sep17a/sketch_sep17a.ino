...
void setup()
{
  ...
  */
  logfile.println("millis,stamp,datetime,motion,distance,sound");
  Serial.println("millis,stamp,datetime,motion,distance,sound");
  pinMode(5, OUTPUT);
  pinMode(7, OUTPUT);
  pinMode(6, INPUT);
...
void loop()
{
  ...
  if (digitalRead(6) == HIGH && distance <= 50 && sensorValue >=  26) {
