...
player_data new_player()
{
    ...
    sprite_set_x(result.player_sprite, (float) screen_width()/2 - sprite_width(result.player_sprite)/2);
    sprite_set_y(result.player_sprite, (float) screen_height()/2 - sprite_height(result.player_sprite)/2);
