...
.grid{position:absolute;background:url(/theme/image.php/clean/qtype_ddmarker/1562551461/grid) repeat scroll 0 0}body#page-question-type-ddmarker div[id^=fitem_id_][id*=hint_]{background:#EEE;margin-top:0;margin-bottom:0;padding-bottom:5px;padding-top:5px;border:1px
...
5px 0 20px;background:url(/theme/image.php/clean/core/1562551461/t/expanded) 2px center no-repeat}.path-mod-assign.jsenabled .mod-assign-history-link-closed{padding:0
5px 0 20px;background:url(/theme/image.php/clean/core/1562551461/t/collapsed) 2px center no-repeat}.path-mod-assign.dir-rtl.jsenabled .mod-assign-history-link-closed{padding:0
20px 0 5px;background:url(/theme/image.php/clean/core/1562551461/t/collapsed_rtl) 2px center no-repeat}.path-mod-assign
...
.path-mod-forum .discussion-nav .prev-discussion{float:left}.path-mod-forum .preload-subscribe{background:url(/theme/image.php/clean/mod_forum/1562551461/t/subscribed) no-repeat -9999px -9999px}.path-mod-forum .preload-unsubscribe{background:url(/theme/image.php/clean/mod_forum/1562551461/t/unsubscribed) no-repeat -9999px -9999px}.path-mod-forum
...
.printicon{background:url(/theme/image.php/clean/core/1562551461/t/print) no-repeat scroll 2px center transparent;padding-left:20px}.h5p-data-view
table{border:1px
...
.trafficlight{background:url(/theme/image.php/clean/quiz/1562551461/navflagged) no-repeat top right}.path-mod-quiz .qnbutton.blocked,
...
.printicon{background:url(/theme/image.php/clean/core/1562551461/t/print) no-repeat scroll 2px center transparent;padding-left:20px}#page-mod-wiki-prettyview
...
li{background-image:url(/theme/image.php/clean/mod_workshop/1562551461/userplan/task-todo);background-position:top left;background-repeat:no-repeat;list-style-type:none;min-height:16px;margin: .3em 0}.dir-rtl.path-mod-workshop .userplan tr.phasetasks
li{background-position:top right}.path-mod-workshop .userplan tr.phasetasks
li.completed{background-image:url(/theme/image.php/clean/mod_workshop/1562551461/userplan/task-done)}.path-mod-workshop .userplan tr.phasetasks
li.fail{background-image:url(/theme/image.php/clean/mod_workshop/1562551461/userplan/task-fail)}.path-mod-workshop .userplan tr.phasetasks
li.info{background-image:url(/theme/image.php/clean/mod_workshop/1562551461/userplan/task-info)}.path-mod-workshop .userplan tr.phasetasks
...
.nothingfound{font-size:150%;color:#FF4500}.path-mod-workshop .workshop-risk-dataloss{vertical-align:text-bottom}#page-auth-saml2-selectidp .mform .fitem
div.fitemtitle{width:0}#page-auth-saml2-selectidp .mform .fitem
.felement{margin-left:0}#page-auth-saml2-selectidp
.idpbtn{margin-bottom:10px}#page-auth-saml2-avilableidps .femptylabel
.fitemtitle{display:none}#page-auth-saml2-avilableidps .femptylabel
.felement{margin-left:10px}.block_activity_results{text-align:center}.block_activity_results
...
0 4px;padding:0px;width:100px;height:20px;position:relative;background:url(/theme/image.php/clean/core/1562551461/i/star-rating) top left repeat-x;float:left}#page-blocks-community-communitycourse .star-rating
li{padding:0px;margin:0px;height:20px;width:20px;float:left}#page-blocks-community-communitycourse .star-rating li.current-rating{background:url(/theme/image.php/clean/core/1562551461/i/star-rating) left bottom;position:absolute;height:20px;display:block;text-indent:-9000px;z-index:1}#page-blocks-community-communitycourse
...
0 2px 0;border:1px
solid #ddd;text-align:center;color:#999;font-size:14px;background-color:white}.sorting{background:url(/theme/image.php/clean/block_configurable_reports/1562551461/datatable/sort_both) no-repeat center right}.sorting_asc{background:url(/theme/image.php/clean/block_configurable_reports/1562551461/datatable/sort_asc) no-repeat center right}.sorting_desc{background:url(/theme/image.php/clean/block_configurable_reports/1562551461/datatable/sort_desc) no-repeat center right}.sorting_asc_disabled{background:url(/theme/image.php/clean/block_configurable_reports/1562551461/datatable/sort_asc_disabled) no-repeat center right}.sorting_desc_disabled{background:url(/theme/image.php/clean/block_configurable_reports/1562551461/datatable/sort_desc_disabled) no-repeat center right}table.dataTable thead th:active,
...
.tree_item.branch{padding-left:21px;cursor:pointer;background-image:url('/theme/image.php/clean/core/1562551461/t/expanded')}.block_navigation .block_tree
.tree_item.emptybranch{padding-left:21px;background-image:url('/theme/image.php/clean/core/1562551461/t/collapsed_empty')}.block_navigation .block_tree
.tree_item.loadingbranch{background-image:url('/theme/image.php/clean/core/1562551461/i/loading_small')}.block_navigation .block_tree .tree_item
...
.tree_item.branch{background-image:url('/theme/image.php/clean/core/1562551461/t/collapsed')}.jsenabled
...
.tree_item.emptybranch{padding-right:21px;padding-left:0;background-image:url('/theme/image.php/clean/core/1562551461/t/collapsed_empty_rtl')}.dir-rtl .block_navigation .block_tree .tree_item
...
.tree_item.branch{background-image:url('/theme/image.php/clean/core/1562551461/t/collapsed_rtl')}.block_online_users .content .list
...
.tree_item.branch{background-image:url(/theme/image.php/clean/core/1562551461/t/expanded);background-position:0 10%;background-repeat:no-repeat}.block_settings .block_tree
.active_tree_node{font-weight:bold}.jsenabled .block_settings .block_tree
.tree_item.branch{cursor:pointer}.jsenabled .block_settings .block_tree
.tree_item.emptybranch{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed_empty);background-position:0 10%;background-repeat:no-repeat}.jsenabled .block_settings .block_tree .collapsed
ul{display:none}.jsenabled .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed)}.ie6 .block_settings .block_tree
...
.tree_item.branch.loadingbranch{background-image:url(/theme/image.php/clean/core/1562551461/i/loading_small)}.jsenabled.dir-rtl .block_settings .block_tree
.tree_item.emptybranch{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed_empty_rtl);background-position:center right}.jsenabled.dir-rtl .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed_rtl)}.block_site_main_menu
...
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/arrow_down)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-arrow a.toggle_closed, #toggle-all .content .toggle-arrow h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="arrow"], body#page-course-edit select#id_toggleiconset option[value="arrow"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/arrow_right)}#toggle-all .content .toggle-arrow-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/arrow_right_glow)}#toggle-all .content .toggle-arrow-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/arrow_down_glow)}.course-content ul.ctopics li.section .content .toggle-bulb a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-bulb a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-bulb a.toggle_open, #toggle-all .content .toggle-bulb h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/bulb_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-bulb a.toggle_closed, #toggle-all .content .toggle-bulb h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="bulb"], body#page-course-edit select#id_toggleiconset option[value="bulb"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/bulb_off)}#toggle-all .content .toggle-bulb-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/bulb_off_glow)}#toggle-all .content .toggle-bulb-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/bulb_on_glow)}.course-content ul.ctopics li.section .content .toggle-cloud a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-cloud a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-cloud a.toggle_open, #toggle-all .content .toggle-cloud h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/cloud_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-cloud a.toggle_closed, #toggle-all .content .toggle-cloud h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="cloud"], body#page-course-edit select#id_toggleiconset option[value="cloud"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/cloud_off)}#toggle-all .content .toggle-cloud-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/cloud_off_glow)}#toggle-all .content .toggle-cloud-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/cloud_on_glow)}.course-content ul.ctopics li.section .content .toggle-eye a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-eye a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-eye a.toggle_open, #toggle-all .content .toggle-eye h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/eye_show)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-eye a.toggle_closed, #toggle-all .content .toggle-eye h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="eye"], body#page-course-edit select#id_toggleiconset option[value="eye"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/eye_hide)}#toggle-all .content .toggle-eye-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/eye_hide_glow)}#toggle-all .content .toggle-eye-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/eye_show_glow)}.course-content ul.ctopics li.section .content .toggle-groundsignal a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-ground-signal a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-groundsignal a.toggle_open, #toggle-all .content .toggle-groundsignal h4 a.off,
#toggle-all .content .toggle-groundsignal-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/ground_signal_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-groundsignal a.toggle_closed, #toggle-all .content .toggle-groundsignal-hover h4 a.off:hover,
#toggle-all .content .toggle-groundsignal h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="groundsignal"], body#page-course-edit select#id_toggleiconset option[value="groundsignal"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/ground_signal_off)}.course-content ul.ctopics li.section .content .toggle-led a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-led a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-led a.toggle_open, #toggle-all .content .toggle-led h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/led_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-led a.toggle_closed, #toggle-all .content .toggle-led h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="led"], body#page-course-edit select#id_toggleiconset option[value="led"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/led_off)}#toggle-all .content .toggle-led-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/led_off_glow)}#toggle-all .content .toggle-led-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/led_on_glow)}.course-content ul.ctopics li.section .content .toggle-point a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-point a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-point a.toggle_open, #toggle-all .content .toggle-point h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/point_down)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-point a.toggle_closed, #toggle-all .content .toggle-point h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="point"], body#page-course-edit select#id_toggleiconset option[value="point"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/point_right)}#toggle-all .content .toggle-point-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/point_right_glow)}#toggle-all .content .toggle-point-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/point_down_glow)}.course-content ul.ctopics li.section .content .toggle-power a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-power a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-power a.toggle_open, #toggle-all .content .toggle-power h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/toggle_plus)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-power a.toggle_closed, #toggle-all .content .toggle-power h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="power"], body#page-course-edit select#id_toggleiconset option[value="power"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/toggle_minus)}#toggle-all .content .toggle-power-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/toggle_minus_glow)}#toggle-all .content .toggle-power-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/toggle_plus_glow)}.course-content ul.ctopics li.section .content .toggle-radio a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-radio a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-radio a.toggle_open, #toggle-all .content .toggle-radio h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/radio_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-radio a.toggle_closed, #toggle-all .content .toggle-radio h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="radio"], body#page-course-edit select#id_toggleiconset option[value="radio"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/radio_off)}#toggle-all .content .toggle-radio-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/radio_off_glow)}#toggle-all .content .toggle-radio-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/radio_on_glow)}.course-content ul.ctopics li.section .content .toggle-smiley a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-smiley a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-smiley a.toggle_open, #toggle-all .content .toggle-smiley h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/smiley_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-smiley a.toggle_closed , #toggle-all .content .toggle-smiley h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="smiley"], body#page-course-edit select#id_toggleiconset option[value="smiley"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/smiley_off)}#toggle-all .content .toggle-smiley-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/smiley_off_glow)}#toggle-all .content .toggle-smiley-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/smiley_on_glow)}.course-content ul.ctopics li.section .content .toggle-square a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-square a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-square a.toggle_open, #toggle-all .content .toggle-square h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/square_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-square a.toggle_closed, #toggle-all .content .toggle-square h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="square"], body#page-course-edit select#id_toggleiconset option[value="square"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/square_off)}#toggle-all .content .toggle-square-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/square_off_glow)}#toggle-all .content .toggle-square-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/square_on_glow)}.course-content ul.ctopics li.section .content .toggle-sunmoon a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-sunmoon a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-sunmoon a.toggle_open, #toggle-all .content .toggle-sunmoon h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/sunmoon_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-sunmoon a.toggle_closed, #toggle-all .content .toggle-sunmoon h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="sunmoon"], body#page-course-edit select#id_toggleiconset option[value="sunmoon"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/sunmoon_off)}#toggle-all .content .toggle-sunmoon-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/sunmoon_off_glow)}#toggle-all .content .toggle-sunmoon-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/sunmoon_on_glow)}.course-content ul.ctopics li.section .content .toggle-switch a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-switch a.toggle_open, body.jsenabled .course-content ul.ctopics li.section .content .toggle-switch a.toggle_open, #toggle-all .content .toggle-switch h4
a.off{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/switch_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-switch a.toggle_closed, #toggle-all .content .toggle-switch h4 a.on,
body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="switch"], body#page-course-edit select#id_toggleiconset option[value="switch"]{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/switch_off)}#toggle-all .content .toggle-switch-hover h4 a.off:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/switch_off_glow)}#toggle-all .content .toggle-switch-hover h4 a.on:hover{background-image:url(/theme/image.php/clean/format_topcoll/1562551461/switch_on_glow)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option, body#page-course-edit select#id_toggleiconset
...
input{width:20px;height:16px;background:transparent url(/theme/image.php/clean/core/1562551461/t/delete) no-repeat center top;margin-top:4px}.gradingform_guide.editor .moveup
input{width:20px;height:15px;background:transparent url(/theme/image.php/clean/core/1562551461/t/up) no-repeat center top;margin-top:4px}.gradingform_guide.editor .movedown
input{width:20px;height:15px;background:transparent url(/theme/image.php/clean/core/1562551461/t/down) no-repeat center top;margin-top:4px}.gradingform_guide.editor .addcriterion input,
.gradingform_guide.editor .addcomment
input{background:transparent url(/theme/image.php/clean/core/1562551461/t/add) no-repeat;display:block;color:#555;font-weight:bold;text-decoration:none}.gradingform_guide.editor .addcriterion input,
.gradingform_guide.editor .addcomment
...
.markingguidecomment{cursor:pointer}.jsenabled .gradingform_guide .markingguidecomment:before{content:url(/theme/image.php/clean/core/1562551461/t/add);padding-right:2px}.dir-rtl.jsenabled .gradingform_guide .markingguidecomment:before{padding-right:0;padding-left:2px}.gradingform_guide
...
input{width:12px;height:12px;background:transparent url(/theme/image.php/clean/core/1562551461/t/delete) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .criterion .controls .duplicate
input{width:12px;height:12px;background:transparent url(/theme/image.php/clean/core/1562551461/t/copy) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .levels .level .delete
input{width:12px;height:16px;background:transparent url(/theme/image.php/clean/core/1562551461/t/delete) no-repeat center center}.dir-rtl .gradingform_rubric.editor .levels .level .delete
input{margin-right: .45em;margin-left:0}.gradingform_rubric.editor .moveup
input{width:12px;height:12px;background:transparent url(/theme/image.php/clean/core/1562551461/t/up) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .movedown
input{width:12px;height:12px;background:transparent url(/theme/image.php/clean/core/1562551461/t/down) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .addcriterion input,
.gradingform_rubric.editor .addlevel
input{background:transparent url(/theme/image.php/clean/core/1562551461/t/add) no-repeat top left;display:block;color:#555;font-weight:bold;text-decoration:none}.gradingform_rubric.editor .addcriterion
...
.rubric_view_pp_launch{background:url(/theme/image.php/clean/plagiarism_turnitin/1562551461/rubric) no-repeat 0px 0px;cursor:pointer;height:34px;width:32px;display:block}.tii_disclosure_links{display:block}.tii_disclosure_links
...
.peermark_reviews_pp_launch{background:url(/theme/image.php/clean/plagiarism_turnitin/1562551461/peermark-reviews) no-repeat 0px 0px;cursor:pointer;margin-top:5px;padding:4px
...
span{padding-left:8px}.plagiarism_turnitin_refreshing_grades{display:none}.peermark_manager_launch{background:url(/theme/image.php/clean/plagiarism_turnitin/1562551461/peermark-settings) no-repeat 0px 0px;cursor:pointer;padding:4px
16px 4px 40px;display:inline;line-height:28px}.plagiarism_turnitin_quickmark_manager_launch{background:url(/theme/image.php/clean/plagiarism_turnitin/1562551461/quickmark) no-repeat 0px 0px;padding:2px
...
0}.rubric_manager_launch{background:url(/theme/image.php/clean/plagiarism_turnitin/1562551461/rubric) no-repeat 0px 0px;padding:2px
...
.collapseexpand{padding-left:20px;background:url(/theme/image.php/clean/core/1562551461/t/collapsed) 2px center no-repeat}.dir-rtl .collapsible-actions
.collapseexpand{padding-right:20px;padding-left:0;background:url(/theme/image.php/clean/core/1562551461/t/collapsed_rtl) right center no-repeat}.collapsible-actions .collapse-all,.dir-rtl .collapsible-actions .collapse-all{background-image:url(/theme/image.php/clean/core/1562551461/t/expanded)}.yui-overlay .yui-widget-bd{background-color:#FFEE69;border:1px
...
.smartselect_submenuitem{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed);background-repeat:no-repeat;background-position:100%}.smartselect.spanningmenu
...
.closebutton{width:25px;height:15px;float:right;vertical-align:middle;display:inline-block;cursor:pointer;padding:0;background-image:url(/theme/image.php/clean/theme/1562551461/sprite);background-repeat:no-repeat;border-style:none}.dir-rtl .moodle-dialogue-base .moodle-dialogue-wrap .moodle-dialogue-hd .yui3-widget-buttons{left:0;right:auto}.moodle-dialogue-base .moodle-dialogue .moodle-dialogue-bd{padding:1em;line-height:2em;color:#555;font-size:12px}.moodle-dialogue-base .moodle-dialogue-wrap .moodle-dialogue-content{padding:0;background:#FFF}.moodle-dialogue-base .moodle-dialogue-fullscreen .moodle-dialogue-hd{padding:10px;font-size:16px}.moodle-dialogue-base .moodle-dialogue-fullscreen .moodle-dialogue-content{overflow:auto;position:absolute;top:0;bottom:50px;left:0;right:0;margin:0;border:0}.moodle-dialogue-base .moodle-dialogue-fullscreen .moodle-dialogue-hd,.moodle-dialogue-base .moodle-dialogue-fullscreen .moodle-dialogue-wrap{border-radius:0}.moodle-dialogue-confirm .confirmation-dialogue{text-align:center}.moodle-dialogue-confirm .confirmation-dialogue
...
.ajaxworking{width:16px;height:16px;position:absolute;right:22px;top:3px;background:url(/theme/image.php/clean/core/1562551461/i/ajaxloader) no-repeat}.dir-rtl.path-course-view
...
a{display:block;background-image:url(/theme/image.php/clean/core/1562551461/i/course);background-repeat:no-repeat;padding-left:21px;background-position:left .2em}.dir-rtl .coursebox>.info>.coursename
...
a{background-image:url(/theme/image.php/clean/core/1562551461/i/mnethost)}.dir-rtl .coursebox>.info>.categoryname
...
div{padding-right:2em;font-size:75%}.course_category_tree .category>.info>.categoryname{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed_empty);background-repeat:no-repeat;padding:2px
18px;margin:3px;background-position:center left}.dir-rtl .course_category_tree .category>.info>.categoryname{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed_empty_rtl);background-position:center right}.course_category_tree .category.with_children>.info>.categoryname{background-image:url(/theme/image.php/clean/core/1562551461/t/expanded);cursor:pointer}.course_category_tree .category.with_children.collapsed>.info>.categoryname{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed)}.dir-rtl .course_category_tree .category.with_children.collapsed>.info>.categoryname{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed_rtl)}.course_category_tree .category.collapsed>.content{display:none}.course_category_tree .category>.info{min-height:20px;padding:19px;margin-bottom:20px;background-color:#f5f5f5;border:1px
...
input{background:#FFF url('/theme/image.php/clean/core/1562551461/a/search') no-repeat 7px 7px;padding:2px
...
solid black}.file-picker .fp-pathbar{display:table-row}.fp-pathbar.empty{display:none}.fp-pathbar .fp-path-folder{background:url('/theme/image.php/clean/theme/1562551461/fp/path_folder') no-repeat 0 0;width:27px;height:12px;margin-left:4px}.dir-rtl .fp-pathbar .fp-path-folder{background:url('/theme/image.php/clean/theme/1562551461/fp/path_folder_rtl') no-repeat right top;width:auto;height:12px;margin-left:4px}.dir-rtl .fp-pathbar
...
.ygtvtn{background:url('/theme/image.php/clean/core/1562551461/y/tn') 0 0 no-repeat;width:17px;height:22px}.dir-rtl .filemanager .ygtvtn,.dir-rtl .file-picker
.ygtvtn{background:url('/theme/image.php/clean/core/1562551461/y/tn_rtl') 0 0 no-repeat;width:17px;height:22px}.file-picker .ygtvtm,.filemanager
.ygtvtm{background:url('/theme/image.php/clean/core/1562551461/y/tm') 0 10px no-repeat;width:13px;height:12px;cursor:pointer}.file-picker .ygtvtmh,.filemanager
.ygtvtmh{background:url('/theme/image.php/clean/core/1562551461/y/tm') 0 10px no-repeat;width:13px;height:12px;cursor:pointer}.file-picker .ygtvtp,.filemanager
.ygtvtp{background:url('/theme/image.php/clean/core/1562551461/y/tp') 0 10px no-repeat;width:13px;height:12px;cursor:pointer}.dir-rtl .file-picker .ygtvtp,.dir-rtl .filemanager
.ygtvtp{background:url('/theme/image.php/clean/core/1562551461/y/tp_rtl') 0 10px no-repeat}.file-picker .ygtvtph,.filemanager
.ygtvtph{background:url('/theme/image.php/clean/core/1562551461/y/tp') 0 10px no-repeat;width:13px;height:22px;cursor:pointer}.dir-rtl .file-picker .ygtvtph,.dir-rtl .filemanager
.ygtvtph{background:url('/theme/image.php/clean/core/1562551461/y/tp_rtl') 0 10px no-repeat}.file-picker .ygtvln,.filemanager
.ygtvln{background:url('/theme/image.php/clean/core/1562551461/y/ln') 0 0 no-repeat;width:17px;height:22px}.dir-rtl .file-picker .ygtvln,.dir-rtl .filemanager
.ygtvln{background:url('/theme/image.php/clean/core/1562551461/y/ln_rtl') 0 0 no-repeat}.file-picker .ygtvlm,.filemanager
.ygtvlm{background:url('/theme/image.php/clean/core/1562551461/y/lm') 0 10px no-repeat;width:13px;height:12px;cursor:pointer}.file-picker .ygtvlmh,.filemanager
.ygtvlmh{background:url('/theme/image.php/clean/core/1562551461/y/lm') 0 10px no-repeat;width:13px;height:12px;cursor:pointer}.file-picker .ygtvlp,.filemanager
.ygtvlp{background:url('/theme/image.php/clean/core/1562551461/y/lp') 0 10px no-repeat;width:13px;height:12px;cursor:pointer}.dir-rtl .file-picker .ygtvlp,.dir-rtl .filemanager
.ygtvlp{background:url('/theme/image.php/clean/core/1562551461/y/lp_rtl') 0 10px no-repeat}.file-picker .ygtvlph,.filemanager
.ygtvlph{background:url('/theme/image.php/clean/core/1562551461/y/lp') 0 10px no-repeat;width:13px;height:12px;cursor:pointer}.dir-rtl .file-picker .ygtvlph,.dir-rtl .filemanager
.ygtvlph{background:url('/theme/image.php/clean/core/1562551461/y/lp_rtl') 0 10px no-repeat}.file-picker .ygtvloading,.filemanager
.ygtvloading{background:transparent url('/theme/image.php/clean/core/1562551461/y/loading') 0 0 no-repeat;width:16px;height:22px}.file-picker .ygtvdepthcell,.filemanager
.ygtvdepthcell{background:url('/theme/image.php/clean/core/1562551461/y/vline') 0 0 no-repeat;width:17px;height:32px}.file-picker .ygtvblankdepthcell,.filemanager
...
solid #BBB;min-height:140px;position:relative}.filemanager .fp-content{overflow:auto;max-height:472px;min-height:157px}.filemanager-container,.filepicker-filelist{overflow:hidden}.fitem.disabled .filepicker-filelist,.fitem.disabled .filemanager-container{background-color:#EBEBE4}.fitem.disabled .fp-btn-choose{color:#999}.fitem.disabled .filepicker-filelist .filepicker-filename{display:none}.fp-iconview .fp-reficons1{position:absolute;height:100%;width:100%;top:0;left:0}.fp-iconview .fp-reficons2{position:absolute;height:100%;width:100%;top:0;left:0}.fp-iconview .fp-file.fp-hasreferences .fp-reficons1{background:url('/theme/image.php/clean/theme/1562551461/fp/link') no-repeat;background-position:bottom right}.fp-iconview .fp-file.fp-isreference .fp-reficons2{background:url('/theme/image.php/clean/theme/1562551461/fp/alias') no-repeat;background-position:bottom left}.filemanager .fp-iconview .fp-file.fp-originalmissing .fp-thumbnail
img{display:none}.filemanager .fp-iconview .fp-file.fp-originalmissing .fp-thumbnail{background:url(/theme/image.php/clean/core/1562551461/s/dead) no-repeat;background-position:center center}.filemanager .yui3-datatable
table{border:0
solid #BBB;width:100%}.filemanager .yui3-datatable-header{background:#FFF !important;border-bottom:1px solid #CCC !important;border-left:0 solid #FFF !important;color:#555 !important}.filemanager .yui3-datatable-odd .yui3-datatable-cell{background-color:#F6F6F6 !important;border-left:0 solid #F6F6F6}.filemanager .yui3-datatable-even .yui3-datatable-cell{background-color:#FFF !important;border-left:0 solid #FFF}.filemanager .fp-filename-icon.fp-hasreferences .fp-reficons1{background:url('/theme/image.php/clean/theme/1562551461/fp/link_sm') no-repeat 0 0;height:100%;width:100%;position:absolute;top:8px;left:17px;z-index:1000}.filemanager .fp-filename-icon.fp-isreference .fp-reficons2{background:url('/theme/image.php/clean/theme/1562551461/fp/alias_sm') no-repeat 0 0;height:100%;width:100%;position:absolute;top:9px;left:-6px;z-index:1001}.filemanager .fp-contextmenu{display:none}.filemanager .fp-iconview .fp-folder.fp-hascontextmenu .fp-contextmenu{display:block;position:absolute;right:7px;bottom:5px}.filemanager .fp-treeview .fp-folder.fp-hascontextmenu .fp-contextmenu,.filemanager .fp-tableview .fp-folder.fp-hascontextmenu .fp-contextmenu{display:inline;position:absolute;left:14px;margin-right:-20px;top:6px}.dir-rtl .filemanager .fp-iconview .fp-folder.fp-hascontextmenu .fp-contextmenu{left:7px;right:inherit}.dir-rtl .filemanager .fp-treeview .fp-folder.fp-hascontextmenu .fp-contextmenu,.dir-rtl .filemanager .fp-tableview .fp-folder.fp-hascontextmenu .fp-contextmenu{left:inherit;right:16px;margin-right:0}.filepicker-filelist .filepicker-container,.filemanager.fm-noitems .fm-empty-container{display:block;position:absolute;top:10px;bottom:10px;left:10px;right:10px;border:2px
...
dashed #6c8cd3;padding-top:85px;text-align:center}.dndupload-message{display:none}.dndsupported .dndupload-message{display:inline}.dnduploadnotsupported-message{display:none}.dndnotsupported .dnduploadnotsupported-message{display:inline}.dndupload-target{display:none}.dndsupported .dndupload-ready .dndupload-target{display:block}.dndupload-uploadinprogress{display:none;text-align:center}.dndupload-uploading .dndupload-uploadinprogress{display:block}.dndupload-arrow{background:url(/theme/image.php/clean/theme/1562551461/fp/dnd_arrow) center no-repeat;width:100%;height:80px;position:absolute;top:5px}.fitem.disabled .filepicker-container,.fitem.disabled .fm-empty-container{display:none}.dndupload-progressbars{padding:10px;display:none}.dndupload-inprogress .dndupload-progressbars{display:block}.dndupload-inprogress .fp-content{display:none}.filemanager.fm-noitems .dndupload-inprogress .fm-empty-container{display:none}.filepicker-filelist.dndupload-inprogress .filepicker-container{display:none}.filepicker-filelist.dndupload-inprogress
...
a.fheader{padding:0
5px 0 20px;margin-left:-20px;background:url(/theme/image.php/clean/core/1562551461/t/expanded) 2px center no-repeat}.dir-rtl .mform fieldset.collapsible legend
a.fheader{padding:0
20px 0 5px;margin-right:-20px;margin-left:0;background-position:right center}.mform fieldset.collapsed legend
a.fheader{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed)}.dir-rtl .mform fieldset.collapsed legend
a.fheader{background-image:url(/theme/image.php/clean/core/1562551461/t/collapsed_rtl)}.jsenabled .mform .collapsed
...
none;line-height:inherit;background:transparent url(/theme/image.php/clean/core/1562551461/t/add) no-repeat 7px 8px;padding-left:26px}#rubric-rubric.gradingform_rubric
...
0 10px 5px}input[id$="_clearbutton"],input[type="reset"]{color:#fff;text-shadow:0 -1px 0 rgba(0,0,0,0.25);background-color:#faa732;background-image:-moz-linear-gradient(top, #fbb450, #f89406);background-image:-webkit-gradient(linear, 0 0, 0 100%, from(#fbb450), to(#f89406));background-image:-webkit-linear-gradient(top, #fbb450, #f89406);background-image:-o-linear-gradient(top, #fbb450, #f89406);background-image:linear-gradient(to bottom, #fbb450, #f89406);background-repeat:repeat-x;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#fffbb450', endColorstr='#fff89406', GradientType=0);border-color:#f89406 #f89406 #ad6704;border-color:rgba(0,0,0,0.1) rgba(0,0,0,0.1) rgba(0,0,0,0.25);*background-color:#f89406;filter:progid:DXImageTransform.Microsoft.gradient(enabled = false)}input[id$="_clearbutton"]:hover,input[type="reset"]:hover,input[id$="_clearbutton"]:focus,input[type="reset"]:focus,input[id$="_clearbutton"]:active,input[type="reset"]:active,input[id$="_clearbutton"].active,input[type="reset"].active,input[id$="_clearbutton"].disabled,input[type="reset"].disabled,input[id$="_clearbutton"][disabled],input[type="reset"][disabled]{color:#fff;background-color:#f89406;*background-color:#df8505}input[id$="_clearbutton"]:active,input[type="reset"]:active,input[id$="_clearbutton"].active,input[type="reset"].active{background-color:#c67605 \9}input[id$="_clearbutton"] .caret,input[type="reset"] .caret{border-top-color:#fff;border-bottom-color:#fff}div.logo{background:url(//moodle.deakincollege.edu.au/pluginfile.php/1/theme_clean/logo/1562551461/logo.png) no-repeat 0 0;display:block;float:left;height:75px;margin:0;padding:0;width:100%}.dir-rtl
div.logo{background:url(//moodle.deakincollege.edu.au/pluginfile.php/1/theme_clean/logo/1562551461/logo.png) no-repeat 100% 0;display:block;float:right}div.signuppanel div.subcontent div.text_to_html>p:nth-child(1){text-align:center}a,a:hover{color:#047c91}h1,h2,h3,h4,h5,h6{color:#047c91}.container-fluid
.brand{display:none}.navbar-inverse .nav li.dropdown.open>.dropdown-toggle, .navbar-inverse .nav li.dropdown.active>.dropdown-toggle, .navbar-inverse .nav li.dropdown.open.active>.dropdown-toggle{background-color:#047c91}.dropdown-menu{background-color:#047c91;margin-top:5px}.jsenabled .navbar-inverse .usermenu .moodle-actionmenu.show{background-color:#003e74}body{padding-top:125px;padding-left:2px;padding-right:2px;color:#1B1B1B;background-color:#FFF;font-family:"PT Sans",Arial,Helvetica,sans-serif}#dock
.dockeditem_container{margin-top:130px}.navbar-inner{#    background-image: url("//moodle.deakincollege.edu.au/pluginfile.php/1/theme_clean/logo/-1/Image20170222175843.png") !important;background-image:url("//moodle.deakincollege.edu.au/pluginfile.php/1/theme_clean/logo/-1/logo.png") !important;background-repeat:no-repeat !important;min-height:80px;background-color:#047c91 !important;background-size:200px 80px;background-repeat:no-repeat;background-position:33px 20%;max-width:1680px;margin:0
auto;padding-right:20px;padding-left:5px}.navbar-inner .container-fluid{padding-top:82px;max-width:1680px;margin:0
auto}#page-header{margin-top:5px}.logo{display:none !important}@media screen and (min-width: 768px) and (max-width:991px){body{padding-top:0px}.navbar-inner{background-position:center 0px;background-size:22%}#dock
.dockeditem_container{margin-top:155px}#page-header{margin-top:0px}#region-main{initial-scale:0.4}}@media screen and (max-width: 768px){body{padding-top:0px}.navbar-inner{background-position:center 10px;background-size:32%}#dock
.dockeditem_container{margin-top:155px}#page-header{margin-top:0px}#region-main{initial-scale:0.6}}